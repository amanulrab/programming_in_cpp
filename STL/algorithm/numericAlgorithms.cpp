...
//    int totalSum = accumulate(arr.begin(),arr.end(),0);//0 ke saath sare element ka sum karna hai
//    cout<<totalSum<<endl;
    ...
    //    cout<<ans<<endl;
       ...
       //partial sum ke liye extra vector lena pdta hai result store karne k liye
